...
export default async function page() {
  ...
  const goal = sdgs.find((sdg) => sdg.number === "8");
  ...
  return (
    <>
      <Container>
        ...
        <Separator
          targetNumber={goal.targetNumber5}
          targetDescription={goal.targetDescription5}
        />
        ...
        <Separator
          targetNumber={goal.targetNumber6}
          targetDescription={goal.targetDescription6}
        />
        ...
        <Separator
          targetNumber={goal.targetNumber7}
          targetDescription={goal.targetDescription7}
        />
