  ...
  navItems: [
    {
      ...
      items: [
        ...
        { key: 'infographics', title: 'Infografik', href: paths.home.infographics },
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'resetPassword', title: 'Reset Password', href: paths.auth.resetPassword },
        { key: 'updatePassword', title: 'Update Password', href: paths.auth.updatePassword },
      ],
    },
    {
      key: 'dashboard',
      items: [
        { key: 'dashboard', title: 'Dashboard', href: paths.dashboard },
      ],
    },
  ],
};
